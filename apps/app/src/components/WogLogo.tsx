interface WogLogoProps {
  className?: string;
  height?: number;
}

export function WogLogo({ className, height = 40 }: WogLogoProps) {
  ...
  return (
    <svg
      ...
      fill="none"
      className={className}
      style={{ height, width: 228 * scale }}
    >
      {/* Flame tip */}
      <path
        d="M42.61 0a6.67 6.67 0 00-6 9.62l6 12.1 6-12.1a6.67 6.67 0 00-6-9.62z"
        fill="#8BC53F"
      />
      {/* Flame body */}
      <path
